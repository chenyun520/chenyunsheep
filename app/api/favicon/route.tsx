...
const faviconMapper: { [key: string]: string } = {
  '((?:zolplay.cn)|(?:zolplay.com)|(?:cn.zolplay.com))':
    'https://chenyun.so/favicons/zolplay.png',
  '(?:github.com)': 'https://chenyun.so/favicons/github.png',
  '((?:t.co)|(?:twitter.com)|(?:x.com))':
    'https://chenyun.so/favicons/twitter.png',
  'coolshell.cn': 'https://chenyun.so/favicons/coolshell.png',
  'vercel.com': 'https://chenyun.so/favicons/vercel.png',
  'nextjs.org': 'https://chenyun.so/favicons/nextjs.png',
}
...
export async function GET(req: NextRequest) {
  ...
  let iconUrl = 'https://chenyun.so/favicon_blank.png'
